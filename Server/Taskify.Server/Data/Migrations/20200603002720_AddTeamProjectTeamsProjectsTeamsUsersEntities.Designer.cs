...
namespace Taskify.Server.Data.Migrations
{
    ...
    [Migration("20200603002720_AddTeamProjectTeamsProjectsTeamsUsersEntities")]
    partial class AddTeamProjectTeamsProjectsTeamsUsersEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taskify.Server.Data.Models.TeamProject", b =>
                {
            ...
            modelBuilder.Entity("Taskify.Server.Data.Models.Issue", b =>
                {
                    ...
                    b.HasOne("Taskify.Server.Data.Models.Status", "Satus")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("Taskify.Server.Data.Models.Sprint", b =>
                {
                    b.HasOne("Taskify.Server.Data.Models.Project", null)
                        .WithMany("Sprints")
                        .HasForeignKey("ProjectId");
                });
