...
>
  ...
  <div className="lg:w-2/3 md:w-2/3 mx-auto">
    <div className="flex flex-wrap -m-2">
      ...
      <div className="p-2 w-full">
        <CustomLabel labelFor="storyPoints">hikaye noktası</CustomLabel>
        <IssueFormsInput
          disabled={disabled}
          handleChange={handleChange}
          handleOnBlur={(event) => handleOnBlur(event, validatePoints, { storyPoints: data.storyPoints })}
      ...
      <div className="p-2 w-full">
        <textarea
          ...
          name="description"
          className="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none h-20 focus:border-teal-500 text-base px-4 py-2 resize-none block"
      ...
      <div className="p-2 w-full">
        <div className="flex flex-wrap -mx-3 mb-2">
          <CustomSelect
            disabled={disabled}
            label={<CustomLabel>Tür</CustomLabel>}
            value={data.type}
            name="type"
            handleChange={handleChange}
          >
          ...
          <CustomSelect
            disabled={disabled}
            label={<CustomLabel>Öncelik</CustomLabel>}
            value={data.priority}
            name="priority"
            handleChange={handleChange}
          >
          ...
          <CustomSelect
            disabled={disabled}
            label={<CustomLabel>Durumu</CustomLabel>}
            value={data.status}
            name="status"
            handleChange={handleChange}
          >
